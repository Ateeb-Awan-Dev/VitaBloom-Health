...
const CTASection = ({ title = "See VitaBloom in your own workflows", subtitle = "Walk through a tailored demo with someone who has deployed across SNFs, assisted living, and life-plan campuses — no generic slide deck." }: CTASectionProps) => (

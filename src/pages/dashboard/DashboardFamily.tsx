            ...
            <tbody>
              {families.map((f) => (
                <tr key={f.id} className="border-b border-border/50">
                  ...
                  <td className="py-2.5"><span className={`text-xs px-2 py-0.5 rounded-full ${f.portalStatus === "Active" ? "bg-vitabloom-success/10 text-vitabloom-success" : "bg-vitabloom-warning/10 text-vitabloom-warning"}`}>{f.portalStatus}</span></td>
                </tr>
              ))}
            </tbody>
          </table>
            ...
            {visitors.map((v) => (
              <div key={v.id} className="flex items-center gap-4 p-3 rounded-lg bg-muted/30">
                ...
                <span className={`text-xs px-2 py-0.5 rounded-full ${
                  v.status === "Checked In" ? "bg-vitabloom-success/10 text-vitabloom-success" :
                  v.status === "Approved" ? "bg-vitabloom-info/10 text-vitabloom-info" :

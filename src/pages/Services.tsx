  ...
  <>
      ...
      <div className="relative container-main py-28 md:py-36">
        <div className="max-w-3xl">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-4xl md:text-6xl font-bold text-primary-foreground leading-[1.05] mb-7 text-balance">
            Modular depth, <span className="text-accent">singular calm</span>
          </motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-primary-foreground/60 leading-relaxed text-lg mb-10">
            Twelve capabilities that share one chart, one schedule, one family thread, and one analytics layer — so your campus does not pay the tax of swivel-chair integration.
          </motion.p>
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="space-y-3">
            {["12 integrated modules", "Major EHR & pharmacy connectivity", "Clinical success desk", "Phased, low-drama rollout"].map((item) => (
    ...
    <section className="section-padding">
      <div className="container-main">
        <SectionHeader badge="Complete platform" title="Depth without clutter" subtitle="Activate what you need now; expand when you are ready. VitaBloom keeps context attached so modules feel like one product, not a patchwork." />

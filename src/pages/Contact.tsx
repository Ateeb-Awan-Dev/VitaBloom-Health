              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">care@vitabloom.health</p>
                    <p className="text-sm text-muted-foreground">support@vitabloom.health</p>
                  </div>
                </div>
                <div className="flex gap-4">
              ...
              {submitted ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <p className="text-xs text-muted-foreground text-center">We respond within 2 business hours · VitaBloom Health™</p>
                  </form>
                </>
              )}
            </motion.div>

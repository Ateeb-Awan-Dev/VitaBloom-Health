...
const posts = [
  {
    ...
    title: "Safer floors: pairing human rounding with intelligent signals",
    excerpt: "How operators reduced preventable falls by combining environmental cues, staffing patterns, and lightweight analytics.",
    category: "Clinical",
    author: "Dr. Priya Sharma",
    date: "Jan 12, 2026",
    readTime: "8 min",
    image: blog1,
    content: `Falls remain one of the most significant safety concerns in senior care facilities, affecting approximately 1 in 3 residents annually. At VitaBloom Health, we've developed a comprehensive data-driven approach that has reduced fall incidents by 47% across our partner facilities.
...
The key takeaway is clear: when we combine human expertise with intelligent technology, we can create significantly safer environments for our elderly residents.`
  },
  {
    ...
    title: "Memory care without mystery: longitudinal signals families understand",
    excerpt: "Translating complex clinical change into clear, respectful updates — without overwhelming busy siblings.",
    category: "Technology",
...
The future of memory care lies in combining compassionate human care with intelligent technology that helps us intervene earlier and more effectively.`
  },
  {
    ...
    title: "Connected devices and HIPAA: a practical checklist for operators",
    excerpt: "Encryption, access reviews, BAAs, and the questions your security officer should ask before plug-in season.",
    category: "Compliance",
...
Compliance is not just a legal requirement — it's a commitment to protecting the privacy and dignity of every resident in your care.`
  },
  {
    ...
    title: "Care plans residents recognize as their own",
    excerpt: "Moving from boilerplate goals to narratives that travel with the resident across wings, shifts, and providers.",
...
The evidence is clear: when we treat residents as individuals with unique stories and preferences, everyone benefits — residents, families, and staff alike.`
  },
  {
    ...
    title: "Retention is a design problem — not only a pay problem",
    excerpt: "Scheduling fairness, documentation burden, and recognition loops that actually land with night-shift teams.",
    category: "Operations",
    author: "HR Advisory",
    date: "Nov 20, 2025",
    readTime: "9 min",
...
Investing in your team isn't just the right thing to do — it's the smartest business decision you can make.`
  },
  {
    ...
    title: "Family portals that feel like a conversation, not a bulletin board",
    excerpt: "Tone, timing, and transparency: what high-satisfaction communities do differently in digital family communication.",
    category: "Engagement",
    author: "Product Team",
    date: "Nov 6, 2025",
    readTime: "6 min",

    ...
    <header className="sticky top-0 z-50 bg-card/70 backdrop-blur-2xl border-b border-border/40">
      <div className="container-main flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="w-10 h-10 rounded-xl logo-tile-gradient flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-md shadow-primary/15">
            <Flower2 className="w-5 h-5 text-primary-foreground" />
          </div>
          <div className="leading-tight">
            <span className="text-lg font-bold tracking-tight text-foreground font-display">VitaBloom</span>
        ...
        <div className="hidden lg:flex items-center gap-3">
          <Link
            to="/book"
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-semibold rounded-xl btn-gradient-accent text-accent-foreground hover:shadow-lg hover:shadow-primary/15 hover:-translate-y-0.5 transition-all duration-300"
          >
          ...
          >
            <div className="container-main py-4 space-y-1">
              ...
              <div className="pt-4 flex flex-col gap-2">
                <Link to="/book" onClick={() => setMobileOpen(false)} className="px-4 py-3 text-sm font-semibold rounded-xl btn-gradient-accent text-accent-foreground text-center">
                  Book Consultation
                </Link>
